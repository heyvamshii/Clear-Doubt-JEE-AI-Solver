...
- NEVER use Unicode math symbols like θ, α, β, ², ³ directly in prose — always use LaTeX inside $...$
- Greek letters: always $\\theta$, $\\alpha$, $\\omega$ — never θ, α, ω as plain text
